...
public class CommentServiceJDBC implements CommentService{
    ...
    public static final String SELECT = "SELECT game, player, comment, playedOn FROM comment WHERE game = ? ORDER BY playedon LIMIT 10";
    public static final String DELETE = "DELETE FROM comment";
    public static final String INSERT = "INSERT INTO comment (game, player, comment, playedOn) VALUES (?, ?, ?, ?)";
